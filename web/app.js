...
document.addEventListener('click', async event => {
  ...
  try {
    ...
    else if (['play','rename','favorite','trash','restore'].includes(button.dataset.action)) await clipAction(button);
